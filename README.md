...
|---|---|---|
| 🔍 Splunk Alerting Framework | Real-time event correlation for live trading | Splunk, SPL, Python |
| 📊 Grafana/Prometheus Stack | Feed staleness and latency dashboards | Prometheus, Grafana, Loki |
| 🤖 RABBIT | AI-assisted request triage using RAG and AWS Bedrock | FastAPI, Python, AWS |
| 🧬 Synthetic Data Generation | GAN-based financial transaction data (Dean's Prize) | CTGAN, Python |
| 🌍 Food Safety Platform | Cloud compliance platform for federal authority | FastAPI, PostgreSQL, Streamlit |

---

## Connect
🔗 **LinkedIn:** [linkedin.com/in/chioma-okpala](https://linkedin.com/in/chioma-okpala)
